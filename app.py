...
app.jinja_env.globals.update(
    ...
    days_away=days_away,
    hearing_alternate_url=hearing_alternate_url,
    hearing_alternate_label=hearing_alternate_label,
    hearing_google_search_url=hearing_google_search_url,
    hearing_committee_url=hearing_committee_url,
    today=date.today,
    abs=abs,
